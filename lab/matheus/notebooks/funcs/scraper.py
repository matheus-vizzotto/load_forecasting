...
def download_carga_horaria(ano_inicio: int, ano_fim: int, printer: bool=False, write: bool=False) -> pd.DataFrame:
    ...
    Args:
        ...
        write (bool): atualiza o csv na pasta "../data"
    ...
    if (get0 == 200) and (getn == 200): # 200: página (ano) disponível
        ...
        if write:
            print("Escrevendo arquivo '../data/hourly_load.csv'.")
...
def download_carga_diaria(ano_inicio: int, ano_fim: int, printer: bool=False, write: bool=False) -> pd.DataFrame:
    ...
    if (get0 == 200) and (getn == 200): # 200: página (ano) disponível
        ...
        df.set_index("date", inplace=True)
        if write:
            print("Escrevendo arquivo '../data/daily_load.csv'.")
            df.to_csv("../../../data/daily_load.csv")
        return df
