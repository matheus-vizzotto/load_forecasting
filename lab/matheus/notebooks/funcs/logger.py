...
def log_dates(estacao: str, ano: int, missing_dates: list, datas_estranhas: list):
    ...
    """
    logger.warning(f"[RESUMO] Estação {estacao}, ano {ano}: DATAS FALTANTES: {missing_dates} | DATAS ESTRANHAS: {datas_estranhas}")# | DATA MÍNIMA: {date_min} | DATA MÁXIMA: {date_max}")
